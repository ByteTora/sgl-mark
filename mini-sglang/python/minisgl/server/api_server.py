...
class OpenAICompletionRequest(BaseModel):
    ...
    watermark_ngram_len: int = 5
    watermark_context_history_size: int = 1024
    ...
    await state.send_one(
        TokenizeMsg(
            ...
            sampling_params=SamplingParams(
                ...
                watermark_keys=req.watermark_keys,
                watermark_ngram_len=req.watermark_ngram_len,
                watermark_context_history_size=req.watermark_context_history_size,
            ),
        )
    )
