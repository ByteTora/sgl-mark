...
// Check if source_location is available
  ...
  #if __has_include(<source_location>) && (__cplusplus >= 202002L || (defined(_MSVC_LANG) && _MSVC_LANG >= 202002L))
    #define HAS_SOURCE_LOCATION 1
  #else
...
#endif
#else
// Fallback implementation for compilers without source_location
namespace std {
